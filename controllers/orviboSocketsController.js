...
exports.getDevices = function () {
	console.log('get devices Orvibo');
	return devices;
};

exports.subscribeOrvibo = function() {
	console.log('subscribe to Orvibo sockets');
	...
	o.on("deviceadded", function(device) {
		...
		// Storing the device in the array to show all connected 
		devices[devices.length] = device;
		console.log('device found and stored in devices');
